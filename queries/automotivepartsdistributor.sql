...
--
-- Database: `automotivepartsdistributor`
--
CREATE DATABASE IF NOT EXISTS `automotivepartsdistributor` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `automotivepartsdistributor`;
